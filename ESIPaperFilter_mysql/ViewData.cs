...
namespace ESIPaperFilter
{
    public partial class ViewData : Form
    {
        ...
        {
            IDataReader ireader = MysqlHelper.ExecuteReader(MysqlHelper.connectionString, CommandType.Text, sql);
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            DataTable table = MysqlHelper.ExecuteDataSet(MysqlHelper.connectionString, CommandType.Text, sql).Tables[0];
