...
namespace FilterData
{
    public partial class FilterInstitute : Form
    {
        ...
        private void cbxFilterInstitute_MouseHover(object sender, EventArgs e)
        {
            string message = "到导出之前，对所有的记录通过一级机构筛选，然后再对筛选出的结果再进行规范机构匹配导出";
            ShowTitleTip(message, cbxFilterInstitute);
        }
